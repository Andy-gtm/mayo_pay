    ...
    <body>
        ...
        <div class="mui-content">
            <div class="mui-content-padded" style="margin: 5px;">
                    ...
                    <div class="mui-input-row">
                         <label>商户号:</label>
                        <input type="text" name="appid" class="mui-input" value="PIqfLJt68R5PTcoB" >
                    </div>
                    <div class="mui-input-row">
                         <label>商户密钥:</label>
                        <input type="text" name="key" class="mui-input" placeholder="" value="c800bc6bf1912c776077df0fb877a19a" style="font-size: 1rem;">
                    </div>
                    <br>
